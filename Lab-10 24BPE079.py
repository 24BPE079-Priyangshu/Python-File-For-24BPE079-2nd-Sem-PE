...
#8. Given a text file, write a program to create another text file deleting the words â€˜aâ€™, â€˜theâ€™, â€˜anâ€™ and replacing each one of them with a blank space.
